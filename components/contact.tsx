  ...
  return (
    <section id="contact" className="relative py-32 px-6 dot-grid" ref={ref}>
      <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
        <div className="h-[400px] w-[600px] rounded-full bg-blue-600/6 blur-[100px]" />
      </div>
      ...
      <div className="relative max-w-3xl mx-auto text-center">
        ...
        >
          <span className="text-xs font-mono text-blue-400/70 uppercase tracking-widest">Let&apos;s work together</span>
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              ...
              className="neon-button inline-flex items-center gap-3 rounded-2xl bg-white/[0.03] px-8 py-4 text-base font-semibold text-white transition-all group"
            >
